...
```typescript
export function getArticles(articleId: string | number): Promise<GetArticlesResponse>
export function getArticles(articleId?: undefined): Promise<GetArticlesResponse[]>
